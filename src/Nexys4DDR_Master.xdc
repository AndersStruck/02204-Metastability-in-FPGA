...
set_property -dict { PACKAGE_PIN N15   IOSTANDARD LVCMOS33 } [get_ports { count_ovf }]; #IO_L11P_T1_SRCC_14 Sch=led16_r
set_property -dict { PACKAGE_PIN G14   IOSTANDARD LVCMOS33 } [get_ports { status }]; #IO_L15N_T2_DQS_ADV_B_15 Sch=led17_b
...
set_property -dict { PACKAGE_PIN C17   IOSTANDARD LVCMOS33 } [get_ports { r_osc }]; #IO_L20N_T3_A19_15 Sch=ja[1]
set_property -dict { PACKAGE_PIN D18   IOSTANDARD LVCMOS33 } [get_ports { clk_out }]; #IO_L21N_T3_DQS_A18_15 Sch=ja[2]
...
set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets ring_1/ring_delay[1]];
